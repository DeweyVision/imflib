...
class BaseResource(abc.ABC):
    ...
    @property
    def edit_range(self) -> otio.opentime.TimeRange:
    ...
    @property
    def timecode_range(self) -> otio.opentime.TimeRange:
...
class Sequence:
    ...
    def timecode_range(self) -> otio.opentime.TimeRange:
        """Timecode range relative to CPL"""
        raise NotImplementedError("Timecode range not implemented for sequences")
...
class Segment:
    ...
    def timecode_range(self) -> otio.opentime.TimeRange:
        """Timecode range relative to CPL"""
        raise NotImplementedError("Timecode range not implemented yet")
...
class EssenceDescriptor:
    ...
    descriptor_data:typing.List[et.Element]=dataclasses.field(default_factory=list())
...
class ContentMaturityRating:
    ...
    audiences:typing.Dict[str,str]=dataclasses.field(default_factory=dict)
...
class Locale:
    ...
    languages:typing.List[str]=dataclasses.field(default_factory=list)
    ...
    content_maturity_ratings:typing.List[ContentMaturityRating]=dataclasses.field(default_factory=list)
...
class EditRate:
    ...
    edit_rate:typing.Tuple[int,int]
...
class Cpl:
    ...
    _segments:typing.List["Segment"]=dataclasses.field(default_factory=list)
    ...
    tc_start:typing.Optional[otio.opentime.RationalTime]=None
    """The starting timecode of this CPL"""

    content_versions:typing.Set["ContentVersion"]=dataclasses.field(default_factory=set)
    ...
    locales:typing.List["Locale"]=dataclasses.field(default_factory=list)
    """The intended audiences for this CPL"""

    # Still need
    essence_descriptors:typing.List["EssenceDescriptor"]=dataclasses.field(default_factory=list)
    """Descriptors intended for scheduling and tracking content referenced by this CPL"""

    extension_properties:typing.List["ExtensionProperty"]=dataclasses.field(default_factory=list)
    ...
    @staticmethod
    def xsd_optional_compositiontimecode(xml:et.Element, ns:typing.Optional[dict]=None, default:typing.Optional=None) -> otio.opentime.RationalTime:
        ...
        if tc_drop:
            # otio standard is to have semicolon instead of last colon for drop frame
            tc_addr = tc_addr[::-1].replace(":", ";", 1)[::-1]

        return otio.opentime.RationalTime.from_timecode(tc_addr, tc_rate)
